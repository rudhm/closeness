...
import { MapPin, Users, Calendar, Share2, Timer } from 'lucide-react';
import { calculateDistance, estimateTravelTime, formatTime } from '../lib/utils';

export const Dashboard = () => {
  const { roomCode, users, targetDate, myLocation, setMyLocation, updateTargetDate, socket } = useStore();
  ...
  const partner = Object.values(users).find((u) => u.id !== socket?.id && u.lat !== undefined);
